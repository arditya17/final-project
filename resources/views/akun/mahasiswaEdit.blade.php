  ...
  <button type="button" class="btn btn-tool" data-card-widget="remove" data-toggle="tooltip" title="Remove">
    ...
    <i class="fas fa-times"></i></button>
        ...
        <div class="form-group">
                <label for="nama_perusahaan">Nama Perusahaan : {{$magang->nama_perusahaan}}</label>
                <input type="hidden" class="form-control" id="nama_perusahaan" name="nama_perusahaan" value="{{$magang->nama_perusahaan}}">
          </div>
        <div class="form-group">
