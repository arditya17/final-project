...
<div class="card-tools">
  ...
  <button type="button" class="btn btn-tool" data-card-widget="remove" data-toggle="tooltip" title="Remove">
    ...
    <i class="fas fa-times"></i></button>
        ...
        <div class="card-body">
        <form method="post" action="/perusahaan/ {{$perusahaan->id}}"> 
        @method ('patch')
        @csrf
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="daerah_perusahaan" name="daerah_perusahaan" value="{{$perusahaan->daerah_perusahaan}}">
            </div>
