    ...
    <i class="fas fa-times"></i></button>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="konsentrasi" id="kelamin" class="form-control" required>
          ...
          <!-- <div class="form-group">
            <label for="judul_mahasiswa">Judul</label>
            <input type="text" class="form-control" id="judul_mahasiswa" placeholder="Masukan Judul">
          </div>

          <div class="form-group">
            <label for="isi_mahasiswa">Isi</label>
            <input type="text" class="form-control" id="isi_mahasiswa" Placeholder="Masukan Isi">
          </div>
